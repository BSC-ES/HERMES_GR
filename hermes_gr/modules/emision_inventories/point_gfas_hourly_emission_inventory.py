...
import os
from hermes_gr.modules.emision_inventories import PointGfasEmissionInventory
from hermes_gr.config import log_message


class PointGfasHourlyEmissionInventory(PointGfasEmissionInventory):
    def __init__(self, options, grid, current_date, inventory_name, source_type, sector, pollutants, inputs_path,
                 ...
                 p_vertical=None, p_speciation=None, countries_shapefile=None):

        log_message("Creating GFAS emission inventory as point source.", level=3)
        super(PointGfasHourlyEmissionInventory, self).__init__(
            ...
            reference_year=reference_year, factors=factors, regrid_mask=regrid_mask, p_vertical=p_vertical,
    ...
    def get_4d_emissions(self):
        ...
        result = super(PointGfasHourlyEmissionInventory, self).get_4d_emissions()
        return result
